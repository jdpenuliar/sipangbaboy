...
public class Congratulations implements Screen {
    ...
    public void show() {
        ...
        heading = new Label("Congratulations!", headingStyle);
        heading.setFontScale(1, 1);
        headingx = new Label("Thank you for playing!", headingStyle);
        headingx.setFontScale(1, 1);
        ...
        table.row();
        table.add(headingx);
        table.getCell(headingx).spaceBottom(100);
        table.row();
